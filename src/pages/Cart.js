    ...
    <div className="w-full bg-gray-100 p-4">
        {
            ...
            <div className="w-full h-full bg-white px-4 col-span-5 xl:col-span-4">
                ...
                <div>
                    {
                        products.map((item) => (
                            <div key={item.id} className="w-full border-b-[1px] border-b-gray-300 py-4 md:p-0 md:py-4 flex items-center gap-6">
                                <div className="w-full flex flex-col md:flex-row items-center gap-6">
                                    ...
                                    <div className='w-full flex flex-col gap-2 xl:gap-1'>
                                        ...
                                        <div className="bg-[#F0F2F2] flex justify-center items-center gap-1 w-24 py-1 text-center drop-shadow-lg rounded-md">
                                            <p>Qty:</p>
                                            <p onClick={() => dispatch(decrementQuantity(item.id))} className="cursor-pointer bg-gray-200 px-2 rounded-sm hover:bg-gray-400 duration-300">
                                                -
                                            </p>
                                            <p>{item.quantity}</p>
                                            <p onClick={() => dispatch(incrementQuantity(item.id))} className="cursor-pointer bg-gray-200 px-2 rounded-sm hover:bg-gray-400 duration-300">
                                                +
                                            </p>
                                        </div>
            ...
            {/*---------- Right part  ----------*/}
            <div className='col-span-5 md:col-span-3 lg:col-span-2 xl:col-span-1 bg-white h-52  items-center p-4'>
                    <div>
