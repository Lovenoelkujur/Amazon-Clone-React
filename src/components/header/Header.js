    ...
    <div className="w-full sticky top-0 z-50">
        <div className='w-full bg-amazon_blue text-white px-4 py-3 flex items-center gap-4'>
            ...
            <div className="h-10 rounded-md hidden lgl:flex flex-grow relative">
                <span onClick={() => setShowAll(!showAll)} className="w-14 h-full bg-gray-200 hover:bg-gray-300 cursor-pointer duration-300 text-sm text-amazon_blue font-titleFont flex items-center justify-center rounded-tl-md rounded-bl-md">
                    All 
                    <span></span>
            ...
            <Link to="/signin">
                <div className='flex flex-col items-start justify-center headerHover'>
                    {
                        userInfo ? ( 
                            <p className="text-sm mdl:text-sm text-white mdl:text-gray-100 font-medium">
                                {userInfo.userName}
                            </p>
                        ) : (
            ...
            <Link to="/cart">
                <div className="flex items-start justify-center headerHover relative">
                    ...
                    <p className="text-xs font-semibold mt-3 text-whiteText">
                        Cart 
                        <span className="absolute text-xs -top-2 left-6 px-[3px] bg-[#f3a847] text-amazon_blue rounded-full flex justify-center items-center">
